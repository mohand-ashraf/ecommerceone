    ...
    return (
        <div className={`${theme === "dark" ? "dark" : ""}`}>
            <div className='bg-white dark:bg-bgall xl:h-[750px] lxl:h-[750px] lgl:h-[900px] mdl:h-[1120px] md:h-[1150px] sml:h-[1150px] xs:h-[1170px] sm:h-[1170px] lg:h-[900px] h-[750px]'>
                <div className='bg-[#E5EDEC] dark:bg-bghead h-[460px] py-10 xs:pt-[210px] sm:pt-[210px] sml:pt-[210px] md:pt-[160px] mdl:pt-[160px] lg:pt-[160px] xl:pt-[160px] lxl:pt-[160px] lgl:pt-[160px] pt-[160px]'>
                    <div className='container md:px-3 sm:px-3 sml:px-3 mdl:px-3 lg:px-3 xl:px-3 lxl:px-0 lgl:px-3 relative mx-auto'>
                        <h1 className='text-[#005E55] dark:text-color1 md:text-[70px] sm:text-[50px] sml:text-[70px] mdl:text-[70px] lg:text-[70px] xl:text-[70px] lxl:text-[70px] lgl:text-[70px] text-[70px] pt-[60px] text-center'>Contact Us</h1>
